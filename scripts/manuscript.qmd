...
ggplot(communication, aes(gender, ppis_1_score, fill=gender)) +
  ...
  labs(x = "Gender",
       y = "Parental Invasive Behaviors Score",
       title = "Boxplot of Parental Invasive Behaviors Score by Gender")
...
ggplot(communication, aes(gender, ppis_total, fill=gender)) +
  ...
  theme(legend.position = "none") +
  labs(x = "Gender",
       y = "Parental Privacy Invasion Scale Total",
       title = "Boxplot of Parental Privacy Invasion Scale Total by Gender")
